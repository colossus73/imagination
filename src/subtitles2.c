...
g_print("%2f\n",progress);
	...
	if( img->current_slide->anim )
		...
		//~ img->current_slide->pattern_filename, progress, img->current_slide->font_color, img->current_slide->font_brdr_color, img->current_slide->font_bg_color, img->current_slide->border_color,
	...
	else
	{
        ...
        //~ img->current_slide->pattern_filename, img->current_slide->font_color, img->current_slide->font_brdr_color, img->current_slide->font_bg_color, img->current_slide->border_color,
        //~ img->current_slide->top_border, img->current_slide->bottom_border, img->current_slide->border_width, img->current_slide->alignment);
	}
                   ...
                   //~ gint			alignment)
{
    ...
    img_text_draw_layout_fade(cr, layout, posx, posy, angle, current_slide, progress_font_color, progress_font_brdr_color,
     ...
     //~ filename, progress_font_color, progress_font_brdr_color,
